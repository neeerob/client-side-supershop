  ...
  const handelStockUpdateProduct = async () => {
    try {
      const data = await axios.post(
        `${process.env.REACT_APP_API_URL}/stock/updateStock/${productId}/${quantity}`
      );
      setOpen(false);
          ...
          <Grid item xs={12} sm={6}>
            <Card style={{ marginRight: "35px" }}>
              <CardContent>
                ...
                >
                  <Typography color="primary" level="h3" variant="plain" noWrap>
              ...
              <div style={{ marginLeft: "35px" }}>
                ...
                <Link
                  to={`/updateinformation/${productId}`}
              ...
              <Modal open={openStock} onClose={() => setOpenStock(false)}>
                ...
                >
                  ...
                  <Typography
                    ...
                    textcolor="text.tertiary"
                  >
                    Are you certain you'd like to increase your product's stock
                    quantity by{" "}
                    <span style={{ color: "#4CAF50" }}>{quantity} units</span>?
                  </Typography>
                  <Box
                    sx={{
                      display: "flex",
                  ...
                  >
                    ...
                    <Button
                      variant="solid"
                      color="success"
                      onClick={handelStockUpdateProduct}
                    >
                      Update Stock
                    </Button>
                  </Box>
